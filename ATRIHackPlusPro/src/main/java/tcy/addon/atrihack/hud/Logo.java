...
public class Logo extends HudElement {
    public static final HudElementInfo<Logo> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "Logo", "You should use fabric api to see it!", Logo::new);
    ...
    private Identifier image = new Identifier("atrihack", "text.png");
    ...
    public void render(HudRenderer renderer) {
        switch (logo.get()) {
            case Text -> image = new Identifier("atrihack", "text.png");
            case NewText -> image = new Identifier("atrihack", "newtext.png");
            case Jello -> image = new Identifier("atrihack", "jellotext.png");
            case Logo -> image = new Identifier("atrihack", "icons/icon.png");
        }
