...
public class PacketHud extends HudElement {
    ...
    public static final HudElementInfo<PacketHud> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT,"Packet Hud", "Displays your average send packets.",PacketHud::new);
