...
public class Welcomer extends HudElement {
    ...
    public static final HudElementInfo<Welcomer> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "Welcomer", "Welcomes you.", Welcomer::new);
    ...
    public void render(HudRenderer renderer) {
        ...
        String text = "Welcome " + mc.player.getName().getString() + " use ATRIHack";
