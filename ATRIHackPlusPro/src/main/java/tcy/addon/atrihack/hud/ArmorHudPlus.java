...
public class ArmorHudPlus extends HudElement {
    ...
    public static final HudElementInfo<ArmorHudPlus> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "ArmorHud+", "A target hud the fuck you thinkin bruv.", ArmorHudPlus::new);
