...
public class ToastNotifications extends HudElement {
    public static final HudElementInfo<ToastNotifications> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "Toast Notifications", "Displays toast notifications on hud.", ToastNotifications::new);
    ...
    public void render(HudRenderer renderer) {
        renderer.post(() -> {
            try {
                Color back = new Color(50, 70, 100, 255);
