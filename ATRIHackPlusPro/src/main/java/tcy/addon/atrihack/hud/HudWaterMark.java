...
public class HudWaterMark extends HudElement {
    ...
    public static final HudElementInfo<HudWaterMark> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "BlackoutWatermark", "The Blackout watermark.", HudWaterMark::new);
    ...
    public void render(HudRenderer renderer) {
        setSize(renderer.textWidth(ATRIHack.BLACKOUT_NAME + " v" + ATRIHack.BLACKOUT_VERSION, true) * scale.get() * scale.get(), renderer.textHeight(true) * scale.get() * scale.get());

        String text = ATRIHack.BLACKOUT_NAME + " v" + ATRIHack.BLACKOUT_VERSION;
        ...
        Renderer2D.TEXTURE.texQuad(x + renderer.textWidth(ATRIHack.BLACKOUT_NAME + " v" + ATRIHack.BLACKOUT_VERSION) * scale.get() * scale.get(),
