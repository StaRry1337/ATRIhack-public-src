...
import tcy.addon.atrihack.managers.NotificationManager;
import tcy.addon.atrihack.utils.gui.TextUtils;
import tcy.addon.atrihack.utils.render.MSAAFramebuffer;
...
import static tcy.addon.atrihack.utils.gui.SmoothUtils.smoothMove;


public class NotificationsHud extends HudElement {
    public static final HudElementInfo<NotificationsHud> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "Notifications", "Displays notifications on hud.", NotificationsHud::new);

    private static final Identifier ERROR_ID = new Identifier("atrihack", "notification/error.png");
    private static final Identifier INFO_ID = new Identifier("atrihack", "notification/info.png");
    private static final Identifier SUCCESS_ID = new Identifier("atrihack", "notification/success.png");
    private static final Identifier WARN_ID = new Identifier("atrihack", "notification/warning.png");
