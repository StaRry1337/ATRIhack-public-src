...
public class TimerPlusCharge extends HudElement {
	public static final HudElementInfo<TimerPlusCharge> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "timer-plus-charge", "Displays timer plus charge.", TimerPlusCharge::new);
	...
	private void render(HudRenderer renderer, String right, Color rightColor) {
		...
		double x2 = renderer.text("", x, y, textColor.get(), shadow.get(), getScale());
