...
public class CatGirl extends HudElement {
    ...
    private final Identifier catgirl = new Identifier("atrihack", "catgirl.png");

    public static final HudElementInfo<CatGirl> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "catgirl", "It's a Cat girl what do you want", CatGirl::new);
