...
public class TargetHud extends HudElement {
    ...
    public static final HudElementInfo<TargetHud> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "TargetHud", "A target hud the fuck you thinkin bruv.", TargetHud::new);
    ...
    public void render(HudRenderer renderer) {
        if (mode.get() == Mode.Blackout) {
            ...
            setSize(width * scale.get()+20, height * scale.get()+20);
