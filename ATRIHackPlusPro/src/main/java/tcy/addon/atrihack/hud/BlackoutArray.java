...
public class BlackoutArray extends HudElement {
    ...
    public static final HudElementInfo<BlackoutArray> INFO = new HudElementInfo<>(ATRIHack.HUD_BLACKOUT, "BlackoutArray", "An ArrayList for blackout features.", BlackoutArray::new);
    ...
    private List<Module> getModules() {
        return Modules.get().getActive()
            .stream()
            .filter(module -> !onlyBlackout.get() || module.category.equals(ATRIHack.ArkMode))
            .collect(Collectors.toList());
    }
