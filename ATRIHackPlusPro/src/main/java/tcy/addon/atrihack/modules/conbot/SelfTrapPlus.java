...
import tcy.addon.atrihack.modules.conbot.BreakCrystal;
...
public class SelfTrapPlus extends ArkModule {
    public SelfTrapPlus() {
        super(ATRIHack.atricombot, "Self Trap+", "Traps yourself with blocks.");
    }
    ...
    private BreakCrystal breakCrystal = null;
    ...
    private void onRender(Render3DEvent event) {
        if (breakCrystal == null){breakCrystal = Modules.get().get(BreakCrystal.class);}
        breakCrystal.toggle();
        timers.update();
        placed.update();
        placing = false;
