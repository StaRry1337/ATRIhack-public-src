...
public class CityBreaker extends ArkModule {
    ...
    public CityBreaker() {
        super(ATRIHack.atricombot, "City Breaker", "Automatically breaks target's city block.");
    }
    ...
    private void onTick(final TickEvent.Pre event) {
        ...
        if( tcy.addon.atrihack.utils.EntityUtils.isBurrowed(target, tcy.addon.atrihack.utils.EntityUtils.BlastResistantType.Any)){
            poss = target.getBlockPos();
            blockPosTarget = ((blockPosTarget == null) ? poss : blockPosTarget);
        }
