...
import tcy.addon.atrihack.utils.Task;
import tcy.addon.atrihack.utils.world.CityUtils;

import static tcy.addon.atrihack.utils.world.BlockInfo.isAir;


public class CityMiner extends ArkModule {
    ...
    public CityMiner() {
        super(ATRIHack.atricombot, "City Miner", "Automatically breaks target's surround with AutoMine.");
    }
