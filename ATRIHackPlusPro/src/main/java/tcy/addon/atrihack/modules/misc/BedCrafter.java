...
import tcy.addon.atrihack.utils.player.CraftUtils;

import java.util.List;

import static tcy.addon.atrihack.utils.entity.EntityInfo.isInHole;
import static tcy.addon.atrihack.utils.entity.EntityInfo.isMoving;
import static tcy.addon.atrihack.utils.misc.Vec3dInfo.closestVec3d;
import static tcy.addon.atrihack.utils.player.CraftUtils.getEmptySlots;
import static tcy.addon.atrihack.utils.player.CraftUtils.isInventoryFull;
import static tcy.addon.atrihack.utils.world.BlockInfo.getBlock;
import static tcy.addon.atrihack.utils.world.BlockInfo.getSphere;

public class BedCrafter extends ArkModule {
    public BedCrafter() {
        super(ATRIHack.atrimisc, "Bed Crafter", "Automatically craft beds.");
    }
