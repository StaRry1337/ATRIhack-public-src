...
public class ItemSucker extends ArkModule {
    ...
    public ItemSucker() {
        super(ATRIHack.atrimisc, "item-sucker", "Automatically collects items on the ground, with various customizable behaviors.");
    }
