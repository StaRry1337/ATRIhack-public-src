...
import tcy.addon.atrihack.mixins.*;
...
public class PacketLogger extends ArkModule {
    public PacketLogger() {
        super(ATRIHack.ArkMode, "Logger", "Logs packets or whatever you want. (only packets rn)");
    }
