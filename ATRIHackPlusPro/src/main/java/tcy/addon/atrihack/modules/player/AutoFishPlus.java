...
public class AutoFishPlus extends ArkModule {
    ...
    private final Setting<Double> pitch = sgrotate.add(new DoubleSetting.Builder()
        .name("pitch")
    ...
    public AutoFishPlus() {
        super(ATRIHack.ArkMode, "auto-fish+", "Automatically fishes for you. to Dcraft");
    }
