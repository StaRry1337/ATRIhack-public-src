package tcy.addon.atrihack.modules.crash;
...
public class ContainerCrash extends Module {
    ...
    public ContainerCrash() {
        super(ATRIHack.Crash, "container-crash", "Lags/crashes servers by spamming container opening packets. Press escape to toggle.");
    }
