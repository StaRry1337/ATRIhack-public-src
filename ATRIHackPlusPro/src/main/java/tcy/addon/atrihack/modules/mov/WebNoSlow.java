...
public class WebNoSlow extends ArkModule {
    public enum WebMode {
        Vanilla,
        Timer,
        Adaptive,
    ...
    public WebNoSlow() {
        super(ATRIHack.atricombot, "WebNoSlow", "An improved no-slow for webs.");
    }
