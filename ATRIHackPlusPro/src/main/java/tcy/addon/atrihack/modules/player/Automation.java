...
import tcy.addon.atrihack.utils.HoleUtils;
...
public class Automation extends ArkModule {
    public Automation() {
        super(ATRIHack.ArkMode, "Automation", "Automatically enables modules in certain situations.");
    }
