...
import static tcy.addon.atrihack.utils.entity.EntityInfo.isSurrounded;
import static tcy.addon.atrihack.utils.world.BlockInfo.getBlock;
import static tcy.addon.atrihack.utils.world.BlockInfo.isAir;


public class TNTAura extends ArkModule {
    ...
    public TNTAura() {
        super(ATRIHack.atricombot, "TNT Aura", "Placing & igniting TNT around enemy");
    }
