...
import tcy.addon.atrihack.modules.conbot.SurroundPlus;
...
import tcy.addon.atrihack.utils.RaksuTone.RaksuPath;
import tcy.addon.atrihack.utils.RaksuTone.RaksuTone;
...
public class AutoPvp extends ArkModule {
    public AutoPvp() {
        super(ATRIHack.atricombot, "Auto PVP", "Follows people using baritone. Best for crystalpvp.cc");
    }
