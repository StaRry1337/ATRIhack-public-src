...
import tcy.addon.atrihack.modules.conbot.SelfTrapPlus;
...
public class AutoMend extends ArkModule {
    public AutoMend() {
        super(ATRIHack.atrimisc, "Auto Mend", "Automatically mends your armor with experience bottles.");
    }
