...
public class StrictNoSlow extends ArkModule {
    public StrictNoSlow() {
        super(ATRIHack.ArkMode, "Strict No Slow", "Should only be used on very strict servers. Requires any other noslow to work.");
    }
