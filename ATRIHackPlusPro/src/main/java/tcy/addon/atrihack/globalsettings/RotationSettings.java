...
public class RotationSettings extends ArkModule {
    public RotationSettings() {
        super(ATRIHack.SETTINGS, "Rotate", "Global rotation settings for every blackout module.");
    }
