...
import tcy.addon.atrihack.mixins.IRaycastContext;
...
public class RaytraceSettings extends ArkModule {
    public RaytraceSettings() {
        super(ATRIHack.SETTINGS, "Raytrace", "Global raytrace settings for every blackout module.");
    }
